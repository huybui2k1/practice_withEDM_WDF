namespace DataAccess.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DataAccess.UniversityContext>
    {
        ...
        protected override void Seed(DataAccess.UniversityContext context)
        {
            ...
            context.Schools.AddOrUpdate(hogwarts);
            ...
            context.Specializations.AddOrUpdate(specializations);
            ...
            context.People.AddOrUpdate(students);

            var teachers = new Teacher[]
            {
            new Teacher { FirstName = "Severus", LastName = "Snape", Qualification = "PhD", Department = departments[0]},
            new Teacher { FirstName = "Albus", LastName = "Dumbledore", Qualification = "PhD", Department =
            departments[0], IsDean = true},
            new Teacher { FirstName = "Minerva", LastName = "McGonagall", Qualification = "PhD", Department =
            departments[1], IsDean = true},
            new Teacher { FirstName = "Rubeus", LastName = "Hagrid", Qualification = "PhD", Department = departments[2],
            IsDean = true},
            ...
            context.People.AddOrUpdate(teachers);
