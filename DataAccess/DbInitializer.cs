...
namespace DataAccess
{
    public class DbInitializer : DropCreateDatabaseIfModelChanges<UniversityContext>
    {
        protected override void Seed(UniversityContext context)
        {
            ...
            new Student { FirstName = "Neville", LastName = "Longbottom", Group = "Gryffindor", Specialization =
            specializations[2]},
            ...
            new Teacher { FirstName = "Albus", LastName = "Dumbledore", Qualification = "PhD", Department = departments[0],
            IsDean = true},
            new Teacher { FirstName = "Minerva", LastName = "McGonagall", Qualification = "PhD", Department = departments[1],
            IsDean = true},
            new Teacher { FirstName = "Rubeus", LastName = "Hagrid", Qualification = "PhD", Department = departments[2], IsDean
            = true},
